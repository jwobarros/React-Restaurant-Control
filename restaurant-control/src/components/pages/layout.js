            ...
            <Row className="h-100">
                <Col md={2} className="bg-light navigation-body">
                    <Nav className="flex-column nav-pills" style={{ minHeight: "100vh" }}>
                        ...
                        <hr className="mt-5" />
                        <Nav.Item>
                            <Nav.Link className="navigation-link mt-3" href="React-Restaurant-Control/#/recipes">Recipes</Nav.Link>
                        </Nav.Item>
                        <Nav.Item>
                            <Nav.Link className="navigation-link mt-3" href="React-Restaurant-Control/#/ingredients">Ingredients</Nav.Link>
                        </Nav.Item>
